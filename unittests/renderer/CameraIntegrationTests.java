...
//
///**
// * Testing integration between ray creation and finding intersections
// */
...
//     */
//    private int countIntersections(Camera camera, Intersectable geometries) {
//        int count = 0;
//        for (int i = 0; i < 3; i++) {
//            for (int j = 0; j < 3; j++) {
//                Ray ray = camera.constructRay(3, 3, i, j);
//                if (geometries.findIntersections(ray) != null) {
//                    count += geometries.findIntersections(ray).size();
//                }
//            }
//        }
//        return count;
...
//        assertEquals(2, countIntersections(camera, sphere), "Wrong number of intersections with sphere");
//    }
//
//    /**
...
//        assertEquals(9, countIntersections(camera, plane), "Wrong number of intersections with plane");
//    }
//
//    /**
...
//        assertEquals(1, countIntersections(camera, triangle), "Wrong number of intersections with triangle");
//    }
//}
