...
public class LightsTests {
   ...
   public void sphereMultipleLights() {
      scene1.geometries.add(sphere);
      scene1.lights.add(new DirectionalLight(new Color(100, 300, 200), new Vector(1, -1, -1)));
      scene1.lights.add(new PointLight(new Color(500, 300, 0), new Point(50, -50, 25))
              .setkL(0.001).setkQ(0.0002));
      scene1.lights.add(new SpotLight(new Color(600, 400, 0), new Point(-50, -50, 25), new Vector(1, 1, -0.5))
              .setkL(0.001).setkQ(0.0001));
   ...
   public void trianglesMultipleLights() {
      scene2.geometries.add(triangle1, triangle2);
      scene2.lights.add(new DirectionalLight(new Color(100, 300, 200), new Vector(-1, -1, -1)));
      scene2.lights.add(new PointLight(new Color(500, 300, 0), new Point(50, -50, 25))
              .setkL(0.001).setkQ(0.0002));
      scene2.lights.add(new SpotLight(new Color(600, 400, 0), new Point(-50, -50, 25), trianglesLightDirection)
              .setkL(0.001).setkQ(0.0001));
