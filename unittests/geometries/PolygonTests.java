...
public class PolygonTests {
    ...
    public void testFindIntersections() {
        ...
        assertNull(polygon.findIntersections(new Ray(new Vector(0, 0, 3),new Point(-1, -1, 0))),
                "Ray isn't outside against edge");

        //TC04:Ray inside the polygon
        assertNull(polygon.findIntersections(new Ray(new Vector(-1, 0, 0),new Point(0, 0, 0))),
