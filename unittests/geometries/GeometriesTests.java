...
public class GeometriesTests {
    ...
    public void findIntersections() {
        ...
        List<GeoPoint> geoPoints = geometries.findGeoIntersections(new Ray(new Point(0.0, 5.0, -1.0), new Vector(0.0, 0.0, 1.0)));
        ...
        List<GeoPoint> result = geometries.findGeoIntersections(new Ray(new Point(0.2, 0.2, -0.6), new Vector(0, 0, 1)));
        assertEquals(4,
                result.size(),
